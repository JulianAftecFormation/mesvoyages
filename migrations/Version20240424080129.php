 ...
 */
final class Version20240424080129 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE visite CHANGE tempmin tempmin INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE visite CHANGE tempmin tempmin INT NOT NULL');
    }
}
